...
\resumeExperience
    ...
    \item Mentored junior developers, guiding them through complex project challenges.
    \resumeItemListEnd
...
\resumeSubHeadingListStart
\resumeExperience
    {Surya Software Systems Private Limited, Bengaluru}
    {Software Development Engineer}
    {Aug 2021 - May 2022}
    \resumeItemListStart
    \item Assisted in developing and maintaining web applications using ASP.NET (C\#) and .NET Core.
    \item Focused on bug fixing and code optimization to enhance system reliability and performance.
    \item Collaborated with senior developers and project leads to implement backend services and develop frontend components.
    ...
    \item Contributed to deployment processes, including configuration and troubleshooting during release cycles.
