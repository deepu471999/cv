...
\section{\textbf{Technical Skills}}
 \begin{itemize}[leftmargin=0.1in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks/Libraries}{: ASP.NET, .NET (Core and Framework), ReactJs, MVC, JQuery, Entity Framework, LINQ } \\
     \textbf{Databases}{: MS SQL Server, Oracle } \\
     \textbf{Coursework}{: Data Structures \& Algorithms, SDLC, Object Oriented Programming (OOP), Database Management System (OOP), Software Engineering principles} \\
...
\resumeItemListStart
  \item Migrated services from WCF to .NET Core WebAPI, significantly improving system performance and scalability.
